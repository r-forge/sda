...
as a dependency of the \texttt{SDA} package.
...
\begin{figure}
<<acreagetwoyears,fig=TRUE,include=FALSE>>=
...
@
\includegraphics{SDA_using_survey-acreagetwoyears}
...
\begin{figure}
<<seedlingsplot,fig=TRUE,include=FALSE>>=
...
@
\includegraphics{SDA_using_survey-acresboxplot}
...
\begin{figure}
<<modelregplot,fig=TRUE,include=FALSE>>=
  ### Figure 3.6, p. 85
...
@
\includegraphics{SDA_using_survey-modelregplot}
...
\begin{figure}
<<acresboxplot,fig=TRUE,include=FALSE>>=
